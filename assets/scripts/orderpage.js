...
if (products.length > 0) {
  ...
  localStorage.setItem("totalAmount", JSON.stringify(totalAmount + 0 + 0));
}
...
document.getElementById("paybtn").addEventListener("click", function (e) {
  ...
  var options = {
    key: "AIzaSyAiwRTYbPsBZukrBa_PCJrz9yVly6bAAVQ",
    amount: payable * 100,
    currency: "INR",
    name: "Green Paradise",
...
document.getElementById("cont").addEventListener("click", () => {
  ...
  let menu2 = document.getElementById("personalInfoCont");
